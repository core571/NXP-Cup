...
void motor_init(void)
{
    ...
    site.x = 0;
    site.y = 0;
    LCD_str(site,"V:", BLUE,RED);
    site.y += 17;
    LCD_str(site,"MP:", BLUE,RED);
    site.y += 17;
    LCD_str(site,"MI:", BLUE,RED);
    site.y += 17;
    LCD_str(site,"MD:", BLUE,RED);
    site.y += 17;
    LCD_str(site,"SA:", BLUE,RED);
    site.y += 17;
    LCD_str(site,"SC:", BLUE,RED);
    site.y += 17;
    LCD_str(site,"SD:", BLUE,RED);
...
{
    static int16 PWMOUT = 0;
    PWMOUT += output;
    
    if(PWMOUT>98||PWMOUT<-98)
    {
        PWMOUT=PWMOUT>0?98:-98;
    }
